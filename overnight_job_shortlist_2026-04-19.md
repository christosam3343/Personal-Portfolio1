...
- Cleaned, organized, and visualized data trends across countries and months using charts and dashboard reporting to surface revenue growth patterns and customer insights.
- Used Python and Prolog to develop an academic monitoring system that automated GPA calculation and improved visibility into student performance status.
- Supported cross-functional operations and fast issue resolution in internship roles, strengthening accuracy, communication, and time-sensitive decision-making.

### Short cover letter base
I am a Master's student in Computer Science at the University of New Haven with hands-on experience in Python, SQL, Excel, and dashboard-based analysis. Through academic and internship projects, I have built KPI reports, organized and interpreted data, and communicated insights clearly to support decisions and operations. I am seeking an internship where I can contribute strong analytical skills while continuing to grow in data analysis, reporting, and business intelligence work.

### Next tailoring priorities
- Build an analyst-focused one-page resume version
- Add explicit links for LinkedIn and GitHub if not already embedded cleanly in the PDF
- Quantify internship impact where possible, especially Sodexo and SportsMax
